...
const faqs = [
  {
    ...
    answer:
      "This workshop is designed for  working professionals,software developers, and entrepreneurs who want to learn modern web development and AI-powered application development.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "The workshop covers , React.js, Next.js,JavaScript, TypeScript Node.js, Vercel Deployment, and AI SDK  with practical demonstrations and real-world use cases.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. All registered Offline and Online participants who attend the workshop will receive an official Certificate of Participation.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Participants attending offline and Online are encouraged to bring a laptop(not mandatory), charger, and notebook to fully participate in the hands-on sessions.",
  },
  {
    question: "Where is the workshop being conducted?",
    answer:
      "The offline workshop will be conducted at Sigmanix Tech Solutions,Sigma Hub, Kondapur, Hyderabad.",
  },
  {
